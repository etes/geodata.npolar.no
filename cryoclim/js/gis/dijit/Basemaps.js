    ...
    var customBasemaps = {
        ...
        satellite: {
            ...
            basemap: new Basemap({
                id: "satellite",
                layers: [new BasemapLayer({
                    url: "http://geodata.npolar.no/arcgis/rest/services/Basisdata_Intern/NP_Landsat_Svalbard_WMTS_25833/MapServer",
					showAttribution: false/*,
                    isReference: true/*,
                    displayLevels: [0, 1, 2, 3, 4, 5, 6, 7]*/
                }), new BasemapLayer({
                    url: "http://geodata.npolar.no/arcgis/rest/services/Basisdata_Intern/NP_Ortofoto_Svalbard_WMTS_25833/MapServer",
					showAttribution: false/*,
                    isReference: true,
