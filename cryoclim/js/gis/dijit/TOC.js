 ...
 */
// change log: 
// 2013-12-06: Removed global name space definition and added: css loader, and loading of template. (David Spriggs)
...
define([
  ...
  var _TOCNode = declare([_Widget, _Templated], {
    ...
    _createRootLayerNode: function(rootLayer) {
      ...
      var metadata = this.rootLayerTOC.config.metadata;
  ...
  var TOC = declare("agsjs.dijit.TOC", [_Widget, Evented], {
     ...
     * @property {string} [metadata] metadata. optional. If not specified, service layer url is used.
